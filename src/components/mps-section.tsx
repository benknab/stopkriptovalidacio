...
function MpCard({ mp }: MpCardProps): JSX.Element {
	...
	return (
		...
		>
			...
			<p className="text-sm text-slate-500">{mp.party}</p>

			<div className="flex gap-2 mt-4 w-full">
				<button
					disabled
					className="flex-1 flex items-center justify-center gap-1.5 px-3 py-2 text-sm font-medium text-slate-400 bg-slate-100 rounded-lg cursor-not-allowed border border-slate-200"
				>
